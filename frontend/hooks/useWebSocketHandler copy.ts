...
export const useWebSocketHandler = (selectedUser: IUser) => {
                ...
                const [personalityTranslationId, setPersonalityTranslationId] =
                                useState<string | null>(null);
                const [messageHistory, setMessageHistory] = useState<
                                MessageHistoryType[]
                >([]);
                const [connectionStatus, setConnectionStatus] =
                                useState("Uninstantiated");
                ...
                const onOpenAuth = async (accessToken: string) => {
                                sendJsonMessage({
                                                ...
                                                personality_translation_id:
                                                                personalityTranslationId,
                                });
                ...
                const muteMicrophone = () => {
                                if (microphoneStream) {
                                                microphoneStream.getAudioTracks().forEach(
                                                                (track) => {
                                                                                track.enabled =
                                                                                                false;
                                                                },
