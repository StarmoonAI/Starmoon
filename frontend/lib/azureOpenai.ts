...
export const generateSuggestion = async (
  ...
  const messages = [
    ...
    },
    {
      ...
      Today Main Emotions & Significant Emotional Shifts with today and yesterday data:\n
      ${cardDataString}
  ...
  if (
    ...
    return "Please talk to one of our AI character in playground to get insights.";
  }
