                ...
                <div className="flex max-w-xl mx-auto w-full mt-8 flex-col lg:w-1/2 px-4  gap-2 text-left m-2">
                        ...
                        <div className="flex flex-col gap-4 my-4">
                                ...
                                <p>
                                        ...
                                        using our Service. These Terms govern
                                ...
                                <p>
                                        The Service is intended for personal and
                                        non-commercial use unless explicitly
                                        agreed upon in writing by us. You agree
                                        not to misuse the Service or help anyone
                                        else do so.
                                </p>
                                ...
                                <p>
                                        When creating an account with us, you
                                        must provide accurate and complete
                                        information. You are responsible for
                                        safeguarding your account and for all
                                        activities or actions under your
                                        account.
                                </p>
                                <p className="text-lg font-semibold">
                                ...
                                <p>
                                        ...
                                        are not owned or controlled by Starmoon
                                        AI. We have no control over, and assume
                                ...
                                <p>
                                        In no event shall Starmoon AI, nor its
                                ...
                                <p>
                                        ...
                                        Terms at any time. What constitutes a
                                        material change will be determined at
                                        our sole discretion.
                                </p>
                                <p className="text-lg font-semibold">
                                        9. Contact Us
