...
export default function Component() {
        return (
                        ...
                        <div className="flex flex-col gap-6 sm:gap-12 md:flex-row items-center sm:mt-4 mb-16">
                                ...
                                <div className="md:w-2/5 px-6">
                                        ...
                                        <p className="text-sm text-muted-foreground/90">
                                                *Preorder now to get access to
                                                Starmoon Voice Premium FREE for
                                                2 months. Deliveries starting
                                                December 2024.
                                        </p>
                                </div>
                        </div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                    Order now and start your adventure with Starmoon AI!
                </p>
                <Button size="lg" className="text-lg px-8">
                    Get Your Starmoon AI Today{" "}
