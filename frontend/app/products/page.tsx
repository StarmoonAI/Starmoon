...
const products: Product[] = [
  {
    ...
    shadow:
      "0 4px 6px rgba(255, 215, 0, 0.2), 0 8px 24px rgba(218, 165, 32, 0.5) !important;",
  },
  {
    ...
    shadow:
      "0 4px 6px rgba(135, 206, 235, 0.2), 0 8px 24px rgba(70, 130, 180, 0.5) !important;",
  },
];
          ...
          <Popover>
            ...
            <PopoverContent className="p-3">
              <p className="text-xs p-0">
                All receipts will reflect Starmoon AI, operating as HeyHaddock,
                Inc. (DBA). Thank you for your understanding.
              </p>
            </PopoverContent>
          </Popover>
        </p>
