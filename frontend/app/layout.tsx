...
export const metadata: Metadata = {
    ...
    title: {
        ...
        template:
            "%s | Starmoon AI - The Compact Device to Bring AI Characters to Life",
    },
    applicationName: "Starmoon AI",
    description:
        "Starmoon is an AI-enabled device that brings objects to life through conversational AI. More than a device, it's your gateway to a world where AI brings magic to the ordinary.",
    authors: [
        {
    ...
    openGraph: {
        ...
        description:
            "Starmoon brings objects to life through engaging, conversational AI experiences. More than a device, it's your gateway to a world where AI brings magic to the ordinary.",
    ...
    twitter: {
        ...
        description:
            "More than a device, Starmoon is your gateway to a world where AI brings magic to the ordinary through engaging learning and interactive experiences.",
        images: ["https://starmoon.app/images/orange.png"],
    },
...
export default async function RootLayout({
    ...
    return (
        ...
        >
            <head>
                <link rel="canonical" href="https://www.starmoon.app" />
                <Script
                    id="product-schema"
