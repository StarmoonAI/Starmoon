...
const Playground: React.FC<PlaygroundProps> = ({
                ...
                const [personalityIdState, setPersonalityIdState] =
                                useState<string>(
                                                currentUser.personality!
                                                                .personality_id, // Initial value from props
                                );
                ...
                const onPersonalityPicked = async (
                ...
                const onLanguagePicked = async (
                                languagePicked: LanguageCodeType,
                ) => {
