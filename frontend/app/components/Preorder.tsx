...
const Preorder = () => {
    ...
    return (
        <div className="p-8 my-16 flex sm:flex-row  flex-col gap-4 max-w-screen-md mx-auto justify-between bg-gradient-to-l from-gray-200 via-fuchsia-200 to-stone-100">
            ...
            <div className="flex flex-col gap-4">
                <h2 className="text-2xl font-semibold">
                    Get Your Starmoon Toy!
                </h2>
                <p className="text-sm font-medium">
                    We are accepting preorders! Get your personalized,
                    AI-enabled toy that fosters a growth-mindset and supplements
                    learning for your child. Preorder now to get 25% off.
                </p>
