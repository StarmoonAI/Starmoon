...
const SettingsDashboard: React.FC<SettingsDashboardProps> = ({
  ...
  const pickToy = async (toy: IToy) => {
    // chooseToy(toy);
    await updateUser(supabase, { toy_id: toy.toy_id }, selectedUser!.user_id);
    toast({
  ...
  return (
    <div className="overflow-hidden w-full flex-auto flex flex-col font-quicksand pl-1">
        ...
        >
          <div className="flex flex-col gap-2 font-baloo2">
            <div className="flex flex-row gap-4 items-center">
              <h1 className="text-4xl font-semibold">Perferences</h1>
            ...
            <p className="text-sm text-gray-600">
              {getCreditsRemaining(selectedUser)} credits remaining
            </p>
          </div>
          <FormField
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full rounded-md">
                <FormLabel className="flex flex-row gap-4 items-center">
                  Briefly describe the user&apos;s interests, personality, and
                  learning style
                </FormLabel>
                <FormControl>
                  <Textarea
          ...
          <FormField
            ...
            render={() => (
              <FormItem>
                <div className="mb-4">
                  <FormLabel className="text-base">Learning modules</FormLabel>
                  <FormDescription>
      ...
      <Separator />
      <Label className="text-md mt-4 font-semibold">Pick your plushie</Label>
      <ToyPicker
        allToys={allToys}
