...
const features = [
  ...
  },
  {
    ...
    description:
      "Understand emotional insights and trends according to real time analytics.",
      ...
      <div className="max-w-6xl mx-auto py-8 px-4 md:py-12">
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <p className="font-inter font-light mt-12 text-lg sm:text-xl leading-8 text-stone-800">
            We designed our AI to be a suitable companion that you can engage
            with anytime. Here are some of the features that we have implemented
