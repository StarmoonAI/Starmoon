...
const features = [
    ...
    },
    {
        ...
        progress: "In development",
        name: "Talk to your images, videos and documents",
        description:
            "Our RAG implementation allows you to talk to your documents.",
            ...
            <div className="max-w-6xl mx-auto py-8 px-4 md:py-12">
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                    ...
                    <p className="font-inter font-light mt-12 text-lg sm:text-xl leading-8 text-stone-800">
                        We designed our AI to be a suitable companion that you
                        can engage with anytime. Here are some of the features
                        that we have implemented and actively developing.
                    </p>
                </div>
                <ul
                    role="list"
