...
const features = [
  {
    ...
    description:
      "Understands and analyse your emotions according to your conversation in real time.",
    source: "images/feature1.png",
  },
  {
    icon: <MessageSquareHeart size={32} strokeWidth={1.7} />,
    progress: "Released",
    name: "Custom AI Speciality",
    description:
      "Understands and analyse your emotions according to your conversation.",
  ...
  },
  {
    ...
    name: "Tiny Size",
    description:
      "As small as the Apple Watch, you can carry the device anywhere",
  ...
  },
  {
    ...
    description:
      "Understands and analyse your emotions according to your voice.",
      ...
      <div className="max-w-6xl mx-auto py-8 px-4 md:py-12">
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <p className="font-inter font-light mt-12 text-lg sm:text-xl leading-8 text-stone-800">
            Our AI designed to supplement learning while reducing screen time
            and providing a more engaging experience
          </p>
        </div>
        <ul role="list" className="grid grid-cols-2 gap-6 sm:grid-cols-3">
          {features.map((feature) => (
            <li key={feature.source} className="relative">
              <div className="bg-white p-[10px] rounded-[30px] shadow-custom_unfocus">
                <div className="aspect-square overflow-hidden rounded-[25px] relative group">
                  <img
                    alt=""
                    src={feature.source}
                    className="h-full w-full object-cover transition-all duration-300 ease-in-out group-hover:scale-110 opacity-80"
                  />
