...
const ChosenPersonalities: LandingPagePersonality[] = [
        {
                ...
                name: "Travel guide",
                description:
                        "A travel guide who can help you plan your next trip.",
        },
        {
                key: "ironman",
                name: "Ironman",
        ...
        },
        {
                ...
                description:
                        "A math tutor who can help you with your math problems.",
        },
        {
                key: "master_chef",
                name: "Master chef",
                description:
                        "A master chef who can help you with your cooking.",
        },
        {
                key: "art_guru",
                name: "Art teacher",
        ...
        },
        {
                ...
                name: "Poet of love",
                description:
                        "A poet of love who can help you with your love life.",
        },
        {
                key: "sherlock",
                name: "SherlockGPT",
...
const CharacterCarouselCard = ({ personality }: CharacterCarouselCardProps) => {
        ...
        const playAudio = (personality: LandingPagePersonality) => {
                ...
                const audio = new Audio(
                        `${voiceSampleUrl}${personality.key}.wav`,
                );
                audio.onended = () => {
                        setPlaying(null);
                        setAudioElement(null);
