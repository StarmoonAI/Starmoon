...
const features = [
        {
                ...
                description:
                        "Choose from a variety of AI characters to interact with.",
        ...
        },
        {
                ...
                description:
                        "Customize your AI's voice to match your preference.",
                        ...
                        <div className="max-w-6xl mx-auto py-8 px-4 md:py-12">
                                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                                        ...
                                        <p className="font-light mt-12 text-lg sm:text-xl leading-8 text-stone-800">
                                                We designed our AI platform to
                                                be a suitable companion that you
                                                can engage with anytime. Here
