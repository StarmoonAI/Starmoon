  ...
  const placeholder = (
    <div className="my-4 bg-gray-50 text-center w-full h-full rounded-lg flex items-center justify-center">
      <p className="text-lg font-medium text-gray-500">
        Talk to a character to see your analytics
      </p>
    </div>
  );
        ...
        <div className="flex flex-col md:flex-row md:space-x-3">
          <div className="w-full">
            ...
            <div className="flex space-x-3">
              <div className="flex-grow">
                <TopCard
                  title={cardData?.["main_emotion_1"]?.title ?? "Emotion"}
              ...
              <div className="flex-grow">
                <TopCard
                  title={cardData?.["main_emotion_2"]?.title ?? "Emotion"}
          ...
          <div className="w-full mt-2 md:mt-0">
            ...
            <div className="flex space-x-3">
              <div className="flex-grow">
                <TopCard
                  title={cardData?.["change_1"]?.title ?? "Emotion"}
              ...
              <div className="flex-grow">
                <TopCard
                  title={cardData?.["change_2"]?.title ?? "Emotion"}
