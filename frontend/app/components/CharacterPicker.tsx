...
const testCharacters: ITestCharacter[] = [
...

  {
    ...
    personality_id: "c6b29c64-6562-4295-bb28-94e1fbd2a7e6",
    character_description:
      "Chez is our neutral-voice. Specialty: Your eco-champion, helping you make daily environment-friendly choices.",
    audio_src: "",
    image_src: "aria_eco_champ.png",
  },
];
              ...
              <div className="w-full md:w-2/5 flex flex-col gap-y-8">
                {testCharacters.map((character, index) => (
                  <TestCharacter
                    ...
                    {...character}
                    toy={
                      allToys.find((toy) => toy.toy_id === character.toy_id)!
                    }
                    personality={
