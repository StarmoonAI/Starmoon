...
const reviews = [
                {
                                ...
                                comment: "I wished to have a toy for my friends kids, chatting just for fun ... and hearing all is 'out-of-the-box' is unbelievable, awesome!",
                                rating: 5,
                                avatar: "KL",
                },
                {
                ...
                },
                {
                                name: "Z Xavi",
                                title: "Tech Enthusiast",
                                comment: "I really see the value in what you're doing, ... it's an open source thing ... that is a truly commendable aim",
                                rating: 5,
                                avatar: "ZX",
                },
];
