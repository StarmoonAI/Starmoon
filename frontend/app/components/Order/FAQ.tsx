...
const qna: qnaProps[] = [
        {
                question: "How do I set up my Starmoon AI Device?",
                answer: "Setting up the Starmoon AI device is easy. Just press the main button on the device, find the Starmoon-XYZ wifi network, and register your device with your email. You'll be chatting with your favorite AI character in seconds.",
        ...
        {
                question: "Can I customize my Starmoon AI's voice and personality?",
        ...
        {
                question: "Can I use Starmoon AI with my documents?",
        ...
        {
                question: "Can I use Starmoon AI with any home wifi network?",
                answer: "Yes! Starmoon AI will automatically connect to up to 5 private wifi networks or your phone hotspot. If you are having trouble connecting, please try restarting the device.",
