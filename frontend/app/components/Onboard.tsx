  ...
  return (
    <div className="overflow-hidden w-full flex-auto flex flex-col font-quicksand pl-1">
      ...
      <p className="text-3xl font-bold mt-5">
        To get started, enter supervision details to get your child&apos;s
        companion set up
      </p>
      <p className="text-md text-gray-500 font-medium">
        Parenting can be hard. It can be even harder when you&apos;re trying to
        balance work, life, and your child&apos;s development. Starmoon AI is
        here to help
      </p>
      <Form {...form}>
        <form
