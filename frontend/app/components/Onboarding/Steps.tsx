...
const Steps: React.FC<{
                ...
                const [selectedType, setSelectedType] =
                                useState<TUserType | null>(null);
                const [doctorAuthCode, setDoctorAuthCode] =
                                useState<string>("");
                ...
                const onClickFormCallback = async () => {
                                if (selectedType === "doctor") {
                                                const res =
                                                                await checkDoctorAction(
                                                                                doctorAuthCode,
                                                                );
                                                if (!res) {
                                                                toast({
                                                                                description: "Your sign-up code did not match our records. Try again or reach out to us for help.",
                                                                });
                                                                return;
                                                }
                                }
                ...
                let heading = "Let's get your Starmoon device & account set up";
                let subHeading =
                                "We want to make sure that your Starmoon is set up to provide you the best experience possible.";
