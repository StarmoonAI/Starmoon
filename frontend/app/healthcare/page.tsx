...
const Sections = [
                {
                                ...
                                description: "Our AI companion helps children feel more at ease during medical procedures by explaining things in a friendly, age-appropriate way they can understand.",
                                imageSrc: "/growth.jpg",
                },
                {
                                title: "Speaking their language",
                                progress: "Complex procedures made simple",
                                description: "Through playful conversation and familiar superhero voices, we help children understand medical procedures in ways that make sense to them.",
                ...
                },
                {
                                ...
                                description: "Whether it's pre-procedure jitters or recovery time, our companion provides constant emotional support and encouragement when children need it most.",
                                imageSrc: "/safety.jpg",
                },
                {
                                title: "Teamwork with healthcare heroes",
                                progress: "Building trust between kids and medical staff",
                                description: "We help create positive associations with health-play staff, making it easier for children to form trusting relationships with their medical team.",
