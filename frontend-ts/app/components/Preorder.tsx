...
const Preorder = () => {
    ...
    return (
        <div className="p-8 flex sm:flex-row rounded-xl flex-col gap-4 max-w-screen-md mx-auto justify-between bg-gradient-to-l from-gray-200 via-fuchsia-200 to-stone-100">
