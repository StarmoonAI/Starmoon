...
CREATE TABLE IF NOT EXISTS "public"."conversations" (
    ...
    "toy_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."inbound" (
    "inbound_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "name" "text",
    "email" "text",
    "type" "text"
...
COMMENT ON TABLE "public"."inbound" IS 'inbound demos and preorders';
...
COMMENT ON TABLE "public"."insights" IS 'reports and insights';
...
CREATE TABLE IF NOT EXISTS "public"."toys" (
    ...
    "hume_ai_config_id" "text" DEFAULT '0'::"text" NOT NULL,
    "third_person_prompt" "text" DEFAULT ''::"text" NOT NULL,
    "image_src" "text" DEFAULT ''::"text" NOT NULL,
    "expanded_prompt" "text" DEFAULT ''::"text" NOT NULL
);

ALTER TABLE "public"."toys" OWNER TO "postgres";

COMMENT ON TABLE "public"."toys" IS 'toy personas';

COMMENT ON COLUMN "public"."toys"."third_person_prompt" IS 'from third person';

COMMENT ON COLUMN "public"."toys"."expanded_prompt" IS 'store more information';
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "supervisee_persona" "text" NOT NULL,
    "supervisee_age" smallint DEFAULT '3'::smallint NOT NULL,
    "toy_name" "text",
    "toy_id" "uuid" DEFAULT '2eab6067-5583-47f9-8850-005ceb08935b'::"uuid",
    "email" "text" DEFAULT ''::"text" NOT NULL,
    "modules" "text"[],
    "most_recent_chat_group_id" "uuid",
    "session_time" integer DEFAULT 0 NOT NULL,
    "avatar_url" "text" DEFAULT ''::"text" NOT NULL,
    CONSTRAINT "users_supervisee_age_check" CHECK (("supervisee_age" > 1))
);
...
COMMENT ON COLUMN "public"."users"."modules" IS 'learning modules';
...
ALTER TABLE ONLY "public"."toys"
    ADD CONSTRAINT "toys_name_key" UNIQUE ("name");
...
ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_toy_id_fkey" FOREIGN KEY ("toy_id") REFERENCES "public"."toys"("toy_id");

ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id");

ALTER TABLE ONLY "public"."insights"
    ADD CONSTRAINT "insights_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id");

ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_toy_id_fkey" FOREIGN KEY ("toy_id") REFERENCES "public"."toys"("toy_id");

CREATE POLICY "Enable all for authenticated users only" ON "public"."insights" TO "authenticated" USING (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."users" FOR INSERT TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable read access for all users" ON "public"."inbound" FOR INSERT WITH CHECK (true);

CREATE POLICY "Enable read access for all users" ON "public"."toys" FOR SELECT USING (true);
...
GRANT ALL ON TABLE "public"."inbound" TO "anon";
GRANT ALL ON TABLE "public"."inbound" TO "authenticated";
GRANT ALL ON TABLE "public"."inbound" TO "service_role";
...
GRANT ALL ON TABLE "public"."toys" TO "anon";
GRANT ALL ON TABLE "public"."toys" TO "authenticated";
GRANT ALL ON TABLE "public"."toys" TO "service_role";
