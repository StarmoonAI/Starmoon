...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        if user_type == "user":
            ...
            A person interacts with you by pressing a button, sends you instructions and you must respond with a conversational style. 
            ...
            Remember, your main role is to bring comfort and reduce fear. Use phrases like "You're doing an amazing job," and "Everything will be just fine," just as the doctor would to ease their concerns. Always prioritize the emotional well-being of the child and ensure that they feel supported and cared for during their interaction with you.
            """
